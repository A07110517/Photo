...
class CDbAuthManager extends CAuthManager
{
	...
	public function createProjectAuthItem($name,$type,$project,$description='',$bizRule=null,$data=null)
	{
		$this->db->createCommand()
			->insert($this->itemTable, array(
				'name'=>$name,
		...
		return new CAuthItem($this,$name,$type,$project,$description,$bizRule,$data);
    }
	/**
